...
\begin{table}
	...
	\begin{tabular}{|l|l|l|l|}
		...
		Gas 	&Schwingungen & Periodendauer [ms] & $\kappa$ \\\hline\hline
			...
			& 1 	& $762.1 \pm 1.1$	& \\%%%%%%%%%%%%%%%%%%%%%%%%% Hier war falsche Formel
			& 10 	& $762.23 \pm 0.24$ 	& \\
...
Da gilt $\kappa=\frac{\Delta p_1}{\Delta p_1-\Delta p_2}$ folgt aus der Proportionalität des Drucks zur Steighöhe (nach \ref[S. 457]{giancoli} gilt: $p=\rho g h$):
